...
% use excel to create chart of greedy and simulatedAnnealing and Piecemeal
...
% using piecemeal solution as initial solution greedy performs just as well as simAnnealing
...
% timing
% 100 iterations of each
% [ack -o "(?<=\('greedy took: ',\s)\d.\d+" greedyTiming.txt >> greedyTiming.txt] to get times out of results file
% make chart in excel
...
% explain methodology of testing
% running them both side by side - not worrying about the solutions given
% extract using similar to timing == [ack -o "(?<='reduced: ',\s)\d.\d+" timing.txt > reducedCalculation.txt]
% 10,000 for reduced and 10,000 for full
% use excel (/Users/johnsi63/Documents/FinalYearProject/code/misc/reducedvsFullcalc.xlsx) and create avg time graph
...
\label{f_maxminDif}
\end{figure}
% do some timing tests for both maxMin methods
% talk about how big-O complexities of both affect choice

\subsubsection{Unit tests}
% why need them and how they work
