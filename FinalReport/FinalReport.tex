...
The piecemeal algorithm is the only break from the traditional style of search algorithms that have so far been discussed. The theoretical differences were discussed in detail in Section \ref{Algorithms}. Moreover it is the most novel approach to solving this problem in this project. 
